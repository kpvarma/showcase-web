...
1. **Data Preprocessing**:
   - Images were preprocessed by resizing them to `(299, 299)` and normalizing pixel values to the range `[-1, 1]`.
...
2. **Feature Extraction**:
   ...
   - The extracted features have a shape of `(8, 8, 2048)`.
...
4. **Text-to-Speech Conversion**:
   - Generated captions were converted to speech using Python's `gTTS` library.
